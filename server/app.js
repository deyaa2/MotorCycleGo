...
(async () => {
  try {
    await mongoose.connect(
      process.env.MONGO_URI || 'mongodb+srv://deaa16zed21_db_user:TZ1p3Af5Vk4XNtj6@deyaacluster.zoadiv2.mongodb.net/test?retryWrites=true&w=majority&appName=DeyaaCluster',
